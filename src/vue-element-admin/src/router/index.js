 ...
 */
export const asyncRoutes = sideBarRouter.data
export const backAsyncRoutes = [
  {
    path: '/',
    component: Layout,
    redirect: '/home',
    children: [
      ...
      },
      {
        ...
        name: 'block',
        hidden: true,
        meta: { title: '区块详情', icon: 'el-icon-reading' }
      },
      {
        ...
        name: 'details',
        hidden: true,
        meta: { title: '交易详情', icon: 'el-icon-reading' }
      }
    ]
  },
  {
  ...
  //     {
  //       path: 'fruit',
  //       component: () => import('@/views/verification/fruit'),
  //       name: 'fruit',
  //       meta: { title: '核验结果'}
  //     }
  //   ]
