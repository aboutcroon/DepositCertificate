<template>
  <div class="boya-view">
      ...
      <el-col :span="24">
        <el-col class="main-input-container">
          <el-col class="normal-input">
            ...
            <Input v-model="formData.api_name" clearable placeholder="请输入接口名称" class="search-input"
    ...
    <el-table
      ...
      <el-table-column prop="c_time" label="调用时间" width="240" show-overflow-tooltip/>
  ...
  export default {
    ...
    data() {
      return {
        ...
        tHeader: ['接口名称', '所属用户', '实际操作用户', '调用传的参数', '调用时间', '调用状态'],
        filterVal: ['api_name', 'owner', 'operator', 'params', 'c_time', 'call_status'],
        valueList: [],
            ...
            for (var i of list) {
              if (i != null) {
                ...
                var json = {
                  ...
                  owner: i.owner,
                  operator: i.operator,
                  development_status: i.development_status,
                  params: i.params,
